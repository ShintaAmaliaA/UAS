                ...
                <tr>
                    ...
                    <td>
                        <select name="jenis_tugas" class="form-control">
                            ...
                            <option value="bahasa10">Bahasa | Kelas 10</option>
                            <option value="ipa10">IPA | Kelas 10</option>
                            <option value="ips10">IPS | Kelas 10</option>
                            <option value="matematika10">| Matematika 10</option>
                            <option value="bahasa11">Bahasa | Kelas 11</option>
                            <option value="ipa11">IPA | Kelas 11</option>
                            <option value="ips11">IPS | Kelas 11</option>
                            <option value="matematika11">| Matematika 12</option>                     
                            <option value="bahasa12">Bahasa | Kelas 12</option>
                            <option value="ipa12">IPA | Kelas 12</option>
                            <option value="ips12">IPS | Kelas 12</option>
                            <option value="matematika12">| Matematika 12</option>
                        </select>
                    </td>
                </tr>   
                <tr>
